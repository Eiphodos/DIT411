...
global latest_eps_threshold
latest_eps_threshold = 1
...
def select_action(state):
    ...
    global latest_eps_threshold
    latest_eps_threshold = eps_threshold
...
def plot_durations():
    #print("leps" + str(latest_eps_threshold))
    eps_plot.append(100 * latest_eps_threshold)
