...
class Draw:
    def __init__(self, gridsize, grid, noDelay):
        ...
        self.window = GraphWin("Wolfs and sheep", 200 * self.grid_size , 200 * self.grid_size)
    ...
    def move_wolf(self, row, column, wolf):
        if wolf == 1:
            new_pos = 200*row + 100, 200*column + 100
